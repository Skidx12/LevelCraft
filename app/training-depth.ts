...
const spring: TrainingDepth[] = [
  {
    opening:"Spring is not annotation magic. It is an object factory and wiring system. This mission begins with plain Java so you can see exactly which work Spring takes over.",
    scenario:"A StudentService needs a StudentRepository. You can create both objects yourself, or describe the components and let Spring create and connect them consistently.",
    prerequisites:[
